            ...
            <div class="row">
                ...
                <div class="row">
                     <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group"><!--Captura de el numero de VLAN-->
                                            <label for="" class="font-weight-bold">VLAN <span style="color: red"><b>*</b></span></label>
                                            <input type="number" min="1" class="form-control" id="vlan" name="vlan"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group"><!--Puerta de enlace de la VLAN-->
                                        <label class="font-weight-bold" for="gateway">Gateway <span style="color: red"><b>*</b></label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group"><!--Rango de inicio de la VLAN-->
                                        <label for="" class="font-weight-bold">Rango inicial <span style="color: red"><b>*</b></span></label>
                                        <input type="text" class="form-control" id="rangoInicial" name="rangoInicial"
                                           pattern="[0-9]{3}\.[0-9]{3}\.[0-9]{1,3}\.[0-9]{1,3}"
                                           title="El campo debe ser llenado en el formato correcto.
                                            &#013; Ejemplo: 192.168.1.0"
                                ...
                                <div class="col-md-6">
                                        ...
                                        <label for="" class="font-weight-bold">Rango final <span style="color: red"><b>*</b></span></label>
                                    ...
                                    <div class="form-group"> <!--Descripción breve sobre la VLAN-->
