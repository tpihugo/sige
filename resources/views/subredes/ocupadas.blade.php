    ...
    <div class="container">
        @if (Auth::check() &&
            ...
            <div class="row">
                                        ...
                                        <td>
                                            <center>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('ips.show', $ip->id) }}" class="btn btn-info btn-sm"><i
                ...
                <script type="text/javascript" src="https://cdnjs.cloudflare.com/gajax/libs/pdfmake/0.1.36/pdfmake.min.js"></script>
