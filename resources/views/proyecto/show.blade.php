                        ...
                        <tbody>
                            @foreach ($actividades as $actividad)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('proyecto-actividad.edit', $actividad->id) }}"
                                            class="btn btn-outline-success">Editar</a></p>
                                        <button class="btn btn-outline-danger eliminar" data-toggle="modal"
                                            data-target="#eliminarModal" data-idactividad="{{ $actividad->id }}"
                                            data-mensaje="{{ $actividad->nombre }}" onclick="eliminarActividad(this)">
                                            Eliminar
                                        </button>
                                    </td>
                                </tr>
