...
<div class="col-md-12 ">
            <div>
            <form action="{{ route('filtroIps') }}" method="post" enctype="multipart/form-data" class="col-sm-12" style="display: inline-flexbox">
                <div class="row">
                        {!! csrf_field() !!}
                        @if ($errors->any())
                            <div class="alert alert-danger">
                        ...
                        <select class="form-control" id="id" name="id">
                            @if (isset($subredElegida->id) && !is_null($subredElegida->id))
                                <option value="{{ $subredElegida->id }}" selected>
                                    ...
                                    Rango de IP: {{ $subredElegida->rangoInicial }} al {{ $subredElegida->rangoFinal }} ,
        ...
        <div class="col-12">
                    <table id="example" class="table table-striped table-bordered" cellspacing="2" width="100%">
                        ...
                        <tr>
                            ...
                            <th><center>IP Ocupada</center></th>
