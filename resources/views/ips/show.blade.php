        ...
        @if(Auth::check() && (Auth::user()->role == 'admin' || Auth::user()->role == 'cta' || Auth::user()->role == 'auxiliar' || Auth::user()->role == 'redes'))
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h2><center><b>IP:</b> {{$ip->ip}}</center></h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                            ...
                            <center><label class="font-weight-bold">Datos del equipo. </label></center>
                                ...
                                <div class="col-md-3 pl-0">
                                    ...
                                    <div class="col-md-12 pl-0">
                                        ...
                                        <label  id="area" name="area" class="form-control" placeholder="Disabled input" disabled>{{$edit->area}}</label>
                                    </div>
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-12 pl-0">
                                      <center>
                                        <a href="{{ route('ocupadas',$ip->Subred_id) }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Regresar</a>
                                        <a href="{{ route('desasignarEquipo', $ip->id) }}" class="btn btn-info" title=""><i class="bi bi-pc-display-horizontal">
