                        ...
                        <div class="col">
                            ...
                            <div class="row align-items-end">
                                <div class="col-md-9 pl-0">
                                    ...
                                    <label for="Subred_id" class="font-weight-bold">Subred <span
                                ...
                                <div class="col-md-3 pl-0">
                                    <label class="font-weight-bold" for="subred">IP <span
                                            style="color: red"><b>*</b></span></label>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 pl-0">
                                    ...
                                    <label class="font-weight-bold" for="equipo">Número de Serie <span
                                            style="color: red"><b>*</b></span></label>
                                    <select class="form-control" class="form-control" id="numero_serie" name="numero_serie"
                                        onchange="datosEquipo()" selected>
                                ...
                                <div class="col-md-6 pl-0">
                                    ...
                                    <label id="mac" name="mac" type="hidden"
                                        class="form-control"placeholder="Disabled input"></label>
                                </div>
                                <div class="col-md-3 pl-0">
                                    <!--Tipo de Equipo.-->
                                    <label class="font-weight-bold" for="subred">Tipo de Equipo:</label>
                                    <label id="tipo" name="tipo" type="hidden" class="form-control"
                                ...
                                <div class="col-md-3 pl-0">
                                    ...
                                    <label id="udg_id" name="udg_id" type="hidden" class="form-control"
                                        placeholder="Disabled input"></label>
                                </div>
                                <div class="col-md-6 pl-0">
                                    ...
                                    <label id="usuario" name="usuario" type="hidden" class="form-control"
                                        placeholder="Disabled input"></label>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <center>
                                        <label class="font-weight-bold">
                                            ...
                                            Si algún dato del equipo está erróneo presioné el botón Morado, para poder
                                            editar los datos. <span style="color: red"><b>*</b></span>
                                        </label>
                                    </center>
                                </div>
                            </div>
