            ...
            <form action="{{ route('articulos.update', $articulo->id) }}" method="POST">
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-6">
                        ...
                        <input type="number" name="codigo" id="codigo" value="{{ $articulo->codigo }}"
                            class="form-control" tabindex="1" required>
                    </div>

                    <div class="col-md-6">
                        <label for="" class="form-label">Cantidad</label>
                        <input type="number" name="cantidad" id="cantidad" value="{{ $articulo->cantidad }}"
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="descripcion" id="descripcion" value="{{ $articulo->descripcion }}"
                ...
                <div class="row g-3 align-items-center">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="observacion" id="observacion" value="{{ $articulo->observacion }}"
                            class="form-control" tabindex="4" required>
                    </div>
                    <div class="col-md-4">
                        <label for="" class="form-label">Id requisicion</label>
                        <input type="text" name="requisicion_id" id="requisicion_id"
                            value="{{ $articulo->requisicion_id }}" class="form-control" tabindex="4" required>
                    </div>
                    <div class="col-md-4">
                        <label for="" class="form-label">Status</label>
                        <select class="form-select" aria-label="Default select example" value="{{ $articulo->status }}"
                            name="status" id="status" tabindex="5">
