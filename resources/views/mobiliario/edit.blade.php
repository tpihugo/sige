...
@section('content')
    <div class="container">
        @if (Auth::check() &&
            ...
            <form action="{{ route('mobiliarios.update', $mobiliario->id) }}" method="post" enctype="multipart/form-data"
                class="col-12">
                @method('PUT')
                <div class="row">
                    <div class="col">
                        ...
                        <div class="row g-3 aling-item-center">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="id_udg" name="id_udg"
                                    value="{{ $mobiliario->id_udg }}">
                            </div>
                            <div class="col-md-3">
                                <label for="fecha_adquisicion">Fecha de Adquisición </label>
                                <input type="date" class="form-control" id="fecha_adquisicion" name="fecha_adquisicion"
                                    value="{{ $mobiliario->fecha_adquisicion }}">
                            </div>
                            <div class="col-md-6">
                                <label for="ubicacion">Ubicación </label>
                                <input type="text" class="form-control" id="ubicacion" name="ubicacion"
                                    value="{{ $mobiliario->ubicacion }}">
                            </div>
                        </div>
                        <br>
                        <div class="row g-3 aling-item-center">
                        ...
                        <div class="row g-3 aling-item-center">
                            <div class="col-md-3">
                                ...
                                <input type="text" class="form-control" id="estatus_sici" name="estatus_sici"
                                    value="{{ $mobiliario->estatus_sici }}">
                            </div>
                            <div class="col-md-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-control" class="form-control" id="busqueda-empleado"
                                    name="id_resguardante">
                                    <option value="{{ $mobiliario->id }}" selected>{{ $mobiliario->nombre }} -
                                        {{ $mobiliario->id_resguardante }}</option>
                                    @foreach ($empleados as $empleado)
                                        <option value="{{ $empleado->id }}">{{ $empleado->nombre }} - {{ $empleado->id }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
