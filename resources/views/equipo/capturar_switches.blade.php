...
@section('content')
    <div class="container">
        @if(Auth::check() && (Auth::user()->role == 'admin' || Auth::user()->role == 'cta' || Auth::user()->role == 'auxiliar' || Auth::user()->role == 'redes'))
            ...
            <form action="{{route('created_switch')}}" method="post" enctype="multipart/form-data" class="col-12">
                <div class="row">
                    <div class="col">
                        {!! csrf_field() !!}
                        @if($errors->any())
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="switch"  value="{{old('switch')}}">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" name="licencias">
