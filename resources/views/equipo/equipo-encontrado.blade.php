                    ...
                    <tbody>
                        ...
                        @foreach ($listadoEquipos as $listadoEquipo)
                            <tr>
                                ...
                                <td>{{ $listadoEquipo->tipo_equipo }} - {{ $listadoEquipo->marca }} -
                                    {{ $listadoEquipo->modelo }}</td>
                                <td>
                                ...
                                <td>{{ $listadoEquipo->detalles }}<br> {{ $listadoEquipo->resguardante }} <br>
                                    {{ $listadoEquipo->localizado_sici }}</td>
                                ...
                                <td>
                                    ...
                                    @if ($listadoEquipo->estatus == 'Localizado')
                                        @if ($listadoEquipo->notas && $listadoEquipo->notas != '-')
                                            <a href="#AggNota"
                                                ...
                                                role="button" class="btn btn-danger" data-toggle="modal">Ver o editar
                                                nota</a>
                                        @else
                                            <a href="#AggNota"
                                                onclick="launchModal( '{{ $listadoEquipo->id }}' , '{{ $listadoEquipo->id_area }}' , '{{ $listadoEquipo->notas }}') "
                                                role="button" class="btn btn-danger" data-toggle="modal">Agregar Nota</a>
                                        @endif
                                        <p><a href="{{ route('cambiar-ubicacion', ['equipo_id' => $listadoEquipo->id, 'tipo' => 'inventario']) }}"
                                    ...
                                    @else
                                        ...
                                        <a href="#AggNota"
                                            onclick="launchModal( '{{ $listadoEquipo->id }}' , '{{ $listadoEquipo->id_area }}' , '{{ $listadoEquipo->notas }}') "
                                            role="button" class="btn btn-danger" data-toggle="modal">Registrar con nota</a>
                                    @endif
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row g-3 align-items-center">
                                        <div class="col-md-12">
                                            ...
                                            <input type="hidden" class="form-control" id="equipo_id" name="equipo_id"
                                                value="#">
