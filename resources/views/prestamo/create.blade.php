                        ...
                        <div class="row g-3 align-items-center">
                            <div class="col-md-8">
                                ...
                                <select class="form-control" class="form-control" id="equipo_id" name="equipo_id">
                                    <option value="{{ $equipoPrestamo->id }}" selected>IdSIGE:
                                        {{ $equipoPrestamo->id }}.**** IdUdeG: {{ $equipoPrestamo->udg_id }}.**** Tipo:
                                        {{ $equipoPrestamo->tipo_equipo }}.**** Marca: {{ $equipoPrestamo->marca }}.****
                                        Modelo: {{ $equipoPrestamo->modelo }}.**** Núm. de Serie
                                        {{ $equipoPrestamo->numero_serie }}</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <label for="accesorios">Accesorios</label>
                                <input type="text" class="form-control" id="accesorios" name="accesorios"
                                    value="{{ old('accesorios') }}" required>
                            </div>
                        </div>
                        <div class="row g-3 align-items-center">
                            <div class="col-md-12">
