                ...
                <div class="col-12">
                    <form action="{{ route('plazas.store') }}" method="post" enctype="multipart/form-data" class="col-12">
                        ...
                        <div class="row align-items-center mt-4">
                            <div class="col-md-12">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" value="{{ old('plaza') }}" spellcheck="true">
                            </div>
                        </div>
                        <br>
                    <div class="row align-items-center">
                        <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" id="carga_horaria" name="carga_horaria" value="{{ old('carga_horaria') }}">
                        </div>
                            <div class="col-md-3">
