...
class MobiliarioController extends Controller
{
	...
	//
        ...
        return redirect('mobiliarios')->with(array(
            'message' => 'El mobiliÃ¡rio se guardo Correctamente'
        ));
    }
	...
	//
       ...
       //
        return redirect('mobiliarios')->with(array(
            'message' => 'El mobiliÃ¡rio se actualizo correctamente'
        ));
    }
...
//
        ...
        //
            return redirect()->route('mobiliarios.index')->with(array(
                "message" => "El mobiliÃ¡rio se ha eliminado correctamente"
            ));
        } else {
            return redirect()->route('home')->with(array(
                "message" => "El mobiliÃ¡rio que trata de eliminar no existe"
            ));
        }
    }
}
