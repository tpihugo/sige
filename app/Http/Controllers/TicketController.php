...
class TicketController extends Controller
{
    ...
    //este el que se modific贸 fin de la modificaci贸n 1
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="exampleModalLabel">驴Seguro que deseas eliminar este curso?</h5>
...
//
        $log = new Log();
        $log->tablas = 'tickets';
        $log->movimimiento = "羠ea id: ".$ticket->area_id. "Solicitante: " .$ticket->solicitante. "Contacto: ". $ticket->contacto. "T閏nico: ". $ticket->tecnico_id."Categoria: ".$ticket->categoria."Prioridad: ".$ticket->prioridad."Estatus: ".$ticket->estatus."Datos de reporte: ".$ticket->datos_reporte."Fecha de reporte: ".$ticket->fecha_reporte."Fecha de inicio: ".$ticket->fecha_inicio. "Fecha de termino: ". $ticket->fecha_termino."Problema: ".$ticket->problema."Soluci髇: ".$ticket->solucion;
...
//
    ...
    public function registrarEquipoTicket($equipo_id, $ticket_id){
        ...
        return redirect('recepcionEquipo/'.$ticket_id)->with(array(
            'message'=>'El Equipo se agreg贸 Correctamente al Ticket'
        ));
    }
