  ...
  <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#indexLogin" > {{ __('Index Login') }} </button>
    ...
    <div class="d-flex container-fluid p-4">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="col-xs-12">
            <label class="h1 text-light" >Bienvenid@s a MEDIATECA</label>
          </div>
          <div class="col-xs-12">
            <p class="text-light h2">¿Comienza Ahora? Ingresa tu email para crear una cuenta.</p>
          </div>
        </div>
        <!--
        <div class="col-lg-7">
          <input class="form-control m-1" placeholder="E-Mail" name="email">
        </div>-->
        <div class="col-lg-8 ms-3 d-flex justify-content-end">
          </div>
      </div>
    </div>
<!-- 
