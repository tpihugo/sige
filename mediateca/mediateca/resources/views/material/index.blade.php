...
<div class="card text-center">
  ...
  <div class="d-flex justify-content-start card-footer text-muted bg-secondary">
    ...
    <div class="pull-left p-2">
      ...
      &nbsp; 
      <a class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modalRegistroNuevo" data-bs-whatever="@new">Nuevo registro</a> 
        <li class="firstli">
...
@csrf
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" name="duracion" id="duracion" aria-describedby="Duración" placeholder="Ejemplo: HH:MM:SS" required>
...
<input type="hidden" class="form-control" name="activo" id="activo" value="1" aria-describedby="activo" >

  <div class="file-loading">
  <label for="file" class="form-label">Video</label>
    <input id="file" name="file" type="file" class="form-control" placeholder="Coloca el video" required>
</div>
<div class="file-loading">
...
<table id="material" class="table table-striped table-bordered dt-responsive nowrap shadow-lg mt-5" style="width:100%">
...
<tbody>
  ...
  <input class="form-check-input bg-danger" type="checkbox" id="flexSwitchCheckChecked" onChange="this.form.submit()" >
  Inicio
</div>
        ...
        @method('PUT')
        <div class="form-check form-switch">
  <input class="form-check-input bg-success" type="checkbox" id="flexSwitchCheckChecked" onChange="this.form.submit()" checked>
  Inicio
</div>
  ...
  Carousel
        ...
        <form action="{{route ('delete',$material->id)}}" method="POST">
            ...
            <a href="/material/{{$material->id}}/edit" class="btn btn-dark"><i class="fa fa-pencil" aria-hidden="true"></i></a>
            @csrf
            @method('PUT')
