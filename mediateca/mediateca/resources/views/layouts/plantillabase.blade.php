...
<html lang="en">
  <head>
    ...
    <title>@yield('titulo','MEDIATECA')(Administrador)</title>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
          <ul class="navbar-nav me-auto mb-2 mb-md-0">
            @if( $rol == "Administrador")
            <li class="nav-item"><a class="nav-link" href="./material">Administración</a></li>
            <li class="nav-item"><a class="nav-link" href="./profiles">Usuarios</a></li>
            @endif
